...
def get_resource(*args: str) -> str:
    """
    Constructs and returns the full absolute path to a resource within 'autoscore/resources'.

    Args:
        *args: A sequence of strings representing the relative path components
               within 'autoscore/resources', e.g., ("other", "devices.zip").
    ...
    try:
        ...
        base = files("autoscore").joinpath("resources")
